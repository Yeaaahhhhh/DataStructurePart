#----------------------------------------------------
# Lab 7, Exercise 1: Singly Linked Lists
# TO DO: complete insert method in SLinkedList class
#
# Author: Dexter Sean 
# Collaborators/references: Xinqi Zhou, a 2nd year CE student
#   - CMPUT 175 provided all code except the insert method
#----------------------------------------------------
...
class SLinkedList:
    ...
    def insert(self,pos,item):
        ...
        if pos == 0:                # try to insert at the head of a list containing one element, or many elements
            self.head = SLinkedListNode(item, self.head)
            self.size += 1
        else:
            previous.setNext(SLinkedListNode(item, current))  # try to insert in the middle of a list containing many elements
            self.size += 1
